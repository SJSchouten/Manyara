...
arraydat = xlsread(inputmeasurements,'Sheet2')
...
fig = figure,
subplot(3,1,1), plot(T18(:,3),T18(:,8),':k')
...
subplot(3,1,2),plot(T18(:,3),T18(:,7),':k')
...
% subplot(3,1,3),plot(T17(:,3),diff(T17(:,8),1),'rx-')
% hold on, plot(T18(:,4),diff(T18(:,8),1),'kx-')
% grid;title('LOI T17/T18');legend('T18','T17','T18 revised depth');xlabel('Depth(cm)');ylabel('Weight percentage organics (%)');
